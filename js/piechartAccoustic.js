...
function piechartAccoustic() {
    ...
    var tooltipAcoustic = d3.select('#piechartAccoustic')
        .append('div')
        .attr('class', 'tooltipAcoustic')

    tooltipAcoustic.append('div')
		.attr('class', 'textAcoustic');


    d3.csv("data/john_accoustics_2020.csv").then(function(csvData) {
